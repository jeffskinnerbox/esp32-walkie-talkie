...
OTAHandler::OTAHandler(void) {
    ...
    blink_rate = OTABLKRATE;     // interval at which to blink LED (milliseconds) during OTA
    standard_rate = STDBLKRATE;  // interval at which to blink LED (milliseconds) after OTA
}
